...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBounds(new java.awt.Rectangle(50, 50, 800, 900));
        setMaximumSize(new java.awt.Dimension(600, 800));
        setPreferredSize(new java.awt.Dimension(834, 950));
        setResizable(false);
        setSize(new java.awt.Dimension(600, 800));

        jPanel1.setBackground(new java.awt.Color(0, 255, 204));
        jPanel1.setMaximumSize(new java.awt.Dimension(300, 400));
        jPanel1.setPreferredSize(new java.awt.Dimension(339, 399));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/day/pkg04/iconfinder_Login_49249.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(3697, 3697, 3697))
        );

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/day/pkg04/modern-login-form-interface-design-with-username-and-password-vector.jpg"))); // NOI18N
        jLabel4.setMinimumSize(new java.awt.Dimension(300, 400));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (username == null || username.isEmpty() || password == null || password.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "You must Enter username and password.");
        } else {
            try {
...
//                Connection connection = DriverManager.getConnection("jdbc:ucanaccess:C:\Java Workspace\Day 05\Day 05\src\database\myDB.mdb");
